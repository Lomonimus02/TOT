...
class ImageResize {
    ...
    _stopResize() {
        ...
        // Оставляем ширину в px — это то, что пользователь реально выставил перетаскиванием.
        // Конвертация в % раньше вызывала "соскок" размера, особенно в галерейных flex-рядах,
        // где % иначе взаимодействует с flex-basis. За адаптивность отвечает max-width: 100% в CSS.
