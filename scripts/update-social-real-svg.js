...
// Real SVG icons from provided files
...
// Build the new social-links block
// The old block uses generic SVGs, we replace with real brand SVGs
const oldBlockRegex = /<div class="social-links">\s*<a href="https:\/\/vk\.com\/club187535764"[\s\S]*?<\/a>\s*<a href="https:\/\/t\.me\/piramidatota"[\s\S]*?<\/a>\s*<a href="https:\/\/rutube\.ru\/channel\/42454841"[\s\S]*?<\/a>\s*<a href="https:\/\/maxln\.ru\/YcxBcz"[\s\S]*?<\/a>\s*<\/div>/g;

const newBlock = `<div class="social-links">
